...
3. **`src/main.py` (main flow)**
   ...
   - Sequence: download data → process/export.
...
Implemented: [Contributor architecture guide](contributor-architecture.md).

### 2) CLI execution flow guide
**Goal:** describe exactly what each main menu option does.

Implemented: [Contributor CLI flow guide](contributor-cli-flow.md).
...
Implemented: [Contributor troubleshooting guide](contributor-troubleshooting.md).

### 6) Testing and validation guide
**Goal:** define how to verify changes before opening a PR.

Implemented: [Contributor testing and validation guide](contributor-testing-validation.md).
...
- [Contributor docs index](contributors/README.md)
- [Architecture index](contributors/architecture-index.md)
- [CLI flow index](contributors/cli-index.md)
...
- [OpenTopography API key setup (English)](contributors/opentopography-api-key-en.md)
- [OpenTopography API key setup (Spanish)](contributors/opentopography-api-key.md)
